...
interface DailySetSourceLinkMapper {
    ...
    fun findAllByDailySetUidAndSourceType(dailySetUid: String, sourceType: Int): List<DailySetSourceLinks>
    ...
    """)
    fun findAllByDailySetUidAndSourceTypeAndVersionsLargerThan(dailySetUid: String, sourceType: Int, oldVersion: Int): List<DailySetSourceLinks>
}